...
typedef enum fsm_state {
	//TODO	Posibles estados de la m�quina de estados del dron
	STOPPED,
	RISING,
	STABLE,
	DESCENDING,
...
int parse_and_update(dron_fsm_t* dron_fsm);		//Leo UN mensaje de la lista, lo traduzco y actualizo los flags seg�n corresponda
